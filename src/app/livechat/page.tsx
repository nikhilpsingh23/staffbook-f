              ...
              <div className="p-4 border-b border-gray-200">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B5DE6] focus:border-transparent"
                  />
                 ...
                 {chats.map((chat) => (
                   <div
                     ...
                     className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors ${
                       selectedChat === chat.id ? 'bg-[#F3EFFF] border-r-2 border-[#5B5DE6]' : ''
                     }`}
                   >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-20 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B5DE6] focus:border-transparent"
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-[#5B5DE6] to-[#921294] text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
                  >
                    Send
                  </button>
                </div>
