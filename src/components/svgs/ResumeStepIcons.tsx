...
export const TemplateIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="16" y="16" width="8" height="8" rx="2" fill="#5B5DE6"/>
    <rect x="32" y="16" width="8" height="8" rx="2" fill="#5B5DE6"/>
    <rect x="16" y="32" width="8" height="8" rx="2" fill="#5B5DE6"/>
    <rect x="32" y="32" width="8" height="8" rx="2" fill="#5B5DE6"/>
    <defs>
...
export const InfoIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="28" cy="24" r="6" fill="#5B5DE6"/>
    <rect x="18" y="34" width="20" height="6" rx="3" fill="#5B5DE6"/>
    <defs>
...
export const SuggestionIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M28 18v12" stroke="#5B5DE6" strokeWidth="3" strokeLinecap="round"/>
    <circle cx="28" cy="36" r="3" fill="#5B5DE6"/>
    <defs>
...
export const DownloadIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M28 18v14M28 32l-4-4m4 4l4-4" stroke="#5B5DE6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <defs>
