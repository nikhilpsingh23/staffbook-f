          ...
          <div className="flex flex-wrap gap-4">
            {COURSE_TYPES.map(type => (
              <button
                key={type}
                type="button"
                className={`px-4 py-1 rounded-full border ${form.courseType === type ? 'bg-gradient-to-r from-[#5B5DE6] to-[#921294] text-white border-transparent' : 'bg-white text-gray-700 border-gray-300'} font-medium transition`}
