        ...
        <div className="flex gap-6 md:gap-8 overflow-x-auto pb-4">
          {resumes.map((resume, idx) => (
            ...
            >
              ...
              {/* Button */}
              <button className="mt-auto w-[200px] h-[40px] bg-gradient-to-r from-[#5B5DE6] to-[#921294] text-white rounded-full text-sm font-semibold shadow hover:scale-105 transition">
                Download Resume
              </button>
            </div>
          ))}
