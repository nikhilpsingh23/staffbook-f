          ...
          {featuredJobs.map((job, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center px-3 pt-3 pb-2">
                ...
                <div className="flex gap-1">
                  <div className="w-6 h-6 rounded-full bg-[#f3e8ff] flex items-center justify-center">
                    <Plus size={14} className="text-[#a259e6]" />
                  </div>
                  <div className="w-6 h-6 rounded-full bg-[#f3e8ff] flex items-center justify-center">
                    <Video size={14} className="text-[#a259e6]" />
                  </div>
                </div>
              </div>
              {/* Company Image */}
              ...
              <div className="flex justify-between items-center px-3 mb-2">
                ...
                <div className="w-7 h-7 rounded-full bg-[#f3e8ff] flex items-center justify-center flex-shrink-0 ml-2">
                  <Bookmark size={16} className="text-[#a259e6]" />
                </div>
              </div>
              {/* Info tags */}
              ...
              <div className="flex justify-between items-center px-3 pb-3 mt-auto">
                ...
                <button className="w-[90px] md:w-[100px] h-[28px] md:h-[32px] text-[10px] md:text-xs font-bold rounded-full bg-gradient-to-r from-[#5B5DE6] to-[#921294] text-white shadow-md flex-shrink-0">
                  Apply Now
                </button>
              </div>
            </div>
