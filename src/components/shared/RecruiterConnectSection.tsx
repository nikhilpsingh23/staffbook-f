        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {resumes.map((resume, idx) => (
            ...
            >
              ...
              {/* Button */}
              <button className="mt-auto w-[12.5rem] h-[2.5rem] bg-gradient-to-r from-[#5B5DE6] to-[#921294] text-white rounded-full text-sm font-semibold shadow hover:scale-105 transition">
                Connect
              </button>
            </div>
          ))}
