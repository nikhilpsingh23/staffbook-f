    ...
    Post a job vacancy
      ...
      <div className="space-y-5">
        ...
        <section className="bg-white rounded-lg p-6 border border-gray-200">
          <h2 className="text-[24px] font-semibold bg-gradient-to-r from-[#5B5DE6] to-[#921294] bg-clip-text text-transparent mb-6">
            Upload Media
          </h2>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                ...
                <label htmlFor="companyLogo" className="cursor-pointer">
                  ...
                  <button className="bg-[#CFBFE3] text-black px-4 py-2 rounded-lg text-14">
                    Browse
                  </button>
                </label>
              </div>
      ...
      <div className="flex justify-end gap-4 mt-8">
        <button className="px-6 py-3 border border-gray-300 rounded-full text-16 font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          Preview
        </button>
